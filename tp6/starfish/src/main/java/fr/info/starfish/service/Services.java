...
import fr.info.starfish.Infrastructure; 
...
public class Services {
  ...
  public void init() {
    for (int i = 0; i < titre.length; i++) {
      Infrastructure c = new Infrastructure();
      c.init(titre[i], auteur[i], categorie);
      listeInfrastructure.add(c);
    }
  }
  ...
  public Infrastructure selection() {
    ...
    Infrastructure.init("Asterix, Le Bouclier Arverne", "R. Goscinny, A. Uderzo", "bande dessinee");
